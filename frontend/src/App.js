  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>🎯 Idea Board - v5.0 GitOps Rollback Demo!</h1>
        <div style={{backgroundColor: '#4CAF50', padding: '12px', borderRadius: '8px', marginTop: '10px', fontSize: '16px', animation: 'pulse 2s infinite', border: '2px solid white'}}>
          ✅ GitOps Working | v5.0 | Auto-Deploy: {new Date().toLocaleTimeString()}
        </div>
